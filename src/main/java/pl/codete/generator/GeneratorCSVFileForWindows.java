...
public class GeneratorCSVFileForWindows implements FileGenerator{
  
  public final static String SEPARATOR = ";";
  public final static String NEW_LINE = "\n";
  private final String source = "c:/codete/";
  ...
  @Override
   public void generateCSVFileWithRandomValues(int filesCount) throws IOException, InterruptedException {
    ...
    GeneratorCSVFileForWindows generator = new GeneratorCSVFileForWindows();
